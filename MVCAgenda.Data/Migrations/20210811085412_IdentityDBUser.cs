    ...
    public partial class IdentityDBUser : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SheetPatient", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Consultation_SheetPatient_SheetPatientId",
                        column: x => x.SheetPatientId,
                        principalTable: "SheetPatient",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Patient_SheetPatient_SheetPatientId",
                        column: x => x.SheetPatientId,
                        principalTable: "SheetPatient",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Consultation_SheetPatientId",
                table: "Consultation",
                column: "SheetPatientId");

            migrationBuilder.CreateIndex(
                name: "IX_Patient_SheetPatientId",
                table: "Patient",
                column: "SheetPatientId",
                unique: true);
        }
